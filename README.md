...
- **The finding is not planted.** Each component is given a Weibull life in stress hours and comes off by whichever clock finishes first: flight hours reaching the published interval, or stress reaching its drawn life. On a Coastal airframe the clocks run nearly together (1.17 stress hours per flight hour); on a Highland one the physics clock runs at 2.15 and the hardest-worked airframe in the fleet at 2.18. Nothing says "make Highland worse."
