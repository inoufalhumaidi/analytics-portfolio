...
param(
    [string]$Source = (Join-Path $PSScriptRoot 'Meridian_UAV_Predictive_Maintenance_Case_Study.md'),
    [string]$Html   = (Join-Path $PSScriptRoot 'Meridian_UAV_Predictive_Maintenance_Case_Study.html'),
    [string]$Pdf    = (Join-Path $PSScriptRoot 'Meridian_UAV_Predictive_Maintenance_Case_Study.pdf')
)
...
<title>Meridian UAV Services &mdash; Predictive Maintenance Case Study</title>
<style>$css</style>
</head>
<body>
$($out.ToString())
