...
param(
    [string]$Source = (Join-Path $PSScriptRoot 'Vantage_Receivables_Case_Study.md'),
    [string]$Html   = (Join-Path $PSScriptRoot 'Vantage_Receivables_Case_Study.html'),
    [string]$Pdf    = (Join-Path $PSScriptRoot 'Vantage_Receivables_Case_Study.pdf')
)
...
<title>Vantage Wholesale Supply &mdash; Receivables Case Study</title>
<style>$css</style>
</head>
<body>
$($out.ToString())
