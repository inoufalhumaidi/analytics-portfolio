...
"@
    ...
    $queries = @(
        ...
        @{ Name='tQueue'; File='priority_action_queue.csv'; Types='{"PriorityRank",Int64.Type},{"CollectorRank",Int64.Type},{"CustomerID",type text},{"CustomerName",type text},{"Segment",type text},{"Region",type text},{"RiskTier",type text},{"CollectorID",type text},{"CollectorName",type text},{"Team",type text},{"TermsCode",type text},{"OpenBalance",type number},{"PastDueBalance",type number},{"Balance90Plus",type number},{"DisputedBalance",type number},{"WeightedExposure",type number},{"DisputedWeightedExposure",type number},{"CollectableExposure",type number},{"OldestDaysPastDue",Int64.Type},{"CreditUtilizationPct",type number},{"AvgDaysLateHistoric",type number},{"UnappliedCash",type number},{"NetExposure",type number},{"BrokenPromises90d",Int64.Type},{"ActionCode",type text},{"CreditHoldFlag",Int64.Type},{"IsTodaysWorklist",Int64.Type},{"RecommendedAction",type text}' },
